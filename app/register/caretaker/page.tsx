    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md w-full text-center space-y-4">
          ...
          <p className="text-gray-600">Your caretaker account has been successfully created. Redirecting to login...</p>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-white px-6 py-12">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8 md:p-12">
          <div className="mb-8">
            <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-purple-400 to-purple-600 flex items-center justify-center mb-4 text-white">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
            </div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Caretaker Registration</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* Caretaker ID */}
              <div>
                <label className="block text-sm font-semibold text-gray-900 mb-2">Caretaker ID</label>
                <Input
                  type="text"
                  name="caretakerId"
              ...
              {/* Hostel */}
              <div>
                <label className="block text-sm font-semibold text-gray-900 mb-2">Assigned Hostel</label>
                <select
                  name="hostel"
          ...
          <Button
            type="submit"
            disabled={isLoading}
            className="w-full bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white font-semibold py-3 rounded-lg transition-all duration-200 disabled:opacity-50"
          >
